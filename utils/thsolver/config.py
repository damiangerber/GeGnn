...
_C.SOLVER.save_every_epoch = 10  # Save model every n training epochs
...
_C.DATA.preparation.file_size_threshold = (
    12_048_576  # Threshold to filter out large meshes
)
...
def parse_args(backup=True, config_path=None):
    ...
    parser.add_argument(
        "--config", type=str, default=config_path, help="experiment configure file name"
    )
